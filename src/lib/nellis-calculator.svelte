...
<div class="landing-block">
	...
	<p class="tool-description">
		Easily calculate your bid price based on state taxes and Nellis' buyer premium. Stay informed
...
<section>
	...
	<input
		...
		bind:value={bidPrice}
		on:input={(e) => validateAndSetBidPrice(e.target.value)}
	/>
...
<section>
	<div class="App">
		...
		<input
			...
			bind:value={maxPrice}
			on:input={(e) => validateAndSetMaxPrice(e.target.value)}
		/>
